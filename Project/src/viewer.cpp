...
Viewer::Viewer(int width, int height)
{
    ...
    /*textShader = Shader(shader_dir + "text.vs", shader_dir+"text.fs"); // path relative to binary or CMAKE source dir
...
/*void Viewer::initFreeType()
{
    ...
    //    std::cerr << "ERROR: Font file not found at " << font_path << std::endl;
    //    return;
    //}

    if (FT_New_Face(ft, "/Users/noah-r/Downloads/Roboto/roboto_medium.ttf", 0, &face))
...
{   
    ...
    {   
        ...
        // Render UI
        //renderText("Score: 100", 25.0f, 550.0f, 1.0f, glm::vec3(1.0f, 1.0f, 1.0f));
